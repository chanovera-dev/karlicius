<div id="biography" class="container">
    ...
    <div class="bio">
            ...
            <div class="bio-excerpt">
                <?php echo get_theme_mod('bio_excerpt', 'Me he especializado en Wordpress porque para ti como usuario es fácil de usar y escalar, y yo como desarrollador puedo ofrecerte un sitio totalmente personalizado, rápido y ajustado a tu medida.'); ?>
            </div>
            <?php
