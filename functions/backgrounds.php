            ...
            <?php else: ?>
                ...
                :is(.home,.single-post,.page-template-default) #main-header{position:fixed;width:100%;background-color:transparent;border-bottom:1px solid #ffffff21;}
                    ...
                    :is(.home,.single-post,.page-template-default) #main-header .section .site-brand a:focus{opacity:1;}
                        /* con menú abierto */
                        :is(.home,.single-post,.page-template-default) #main-header.open .section .site-brand a{color:var(--wp--preset--color--text-b);opacity:1;}
                        :is(.home,.single-post,.page-template-default) #main-header.open .section .site-brand a:hover{color:var(--wp--preset--color--text);opacity:1;}
                    /* carrito y wishlist */
