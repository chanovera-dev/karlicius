        ...
        <style>
            ...
            <?php else: ?>
                ...
                @media(min-width:1024px){
                    ...
                    :is(.home,.single-post,.page-template-default) #main-header .menu-searchform__group nav ul li a:focus{opacity:1;}
                    :is(.home,.single-post,.page-template-default) #menu-searchform__group .search-form__wrapper .search-form:focus .search-submit__button{color:var(--wp--preset--color--text-b);opacity:1;}
                } 
            <?php endif; ?>
