    ...
    ?>
        <style>
            ...
            <?php else: ?>
                ...
                .single-post #main-header .section .site-brand a{color:#fff;opacity:.5;}
                .single-post #main-header .section .site-brand a:hover{color:#fff;opacity:1;}
                ...
                @media(min-width:1024px){
                    .single-post #main-header .menu-searchform__group nav ul li a,
                    .single-post #menu-searchform__group .search-form__wrapper .search-form .search-submit__button{color:#fff;opacity:.5;}
                    .single-post #main-header .menu-searchform__group nav ul li a:hover,
                    .single-post #menu-searchform__group .search-form__wrapper .search-form:hover .search-submit__button{opacity:1;}
                } 
            <?php endif; ?>
