    ...
    ?>
        <style>
            ...
            <?php else: ?>
                ...
                :is(.home,.single-post,.page-template-default) #main #hero.header-post.container{background:linear-gradient(to bottom, #0000005b, #00000000), url('<?php the_post_thumbnail_url( 'full' ); ?>');}
