    ...
    ?>
        <style>
            ...
            <?php else: ?>
                ...
                :is(.single-post,.page-template-default) #main-header .section .site-brand a:hover{color:#fff;opacity:1;}
                ...
                :is(.single-post,.page-template-default) #main-header .menu-mobile__button .bars:hover :is(.bar1,.bar2,.bar3){opacity:1;}
                :is(.single-post,.page-template-default) #main-header .menu-mobile__button .bars.change :is(.bar1,.bar2,.bar3){background-color:var(--wp--preset--color--text);opacity:1;}
                /* encabezado de artículo */
                :is(.single-post,.page-template-default) #main .header-post.container{position:relative;padding-top:var(--height--header);background:url('<?php the_post_thumbnail_url( 'full' ); ?>'); background-repeat:no-repeat; background-position:50% 50%; background-size:cover;}
                ...
                :is(.single-post,.page-template-default) #main .header-post.container .section{position:relative;z-index:1;color:#fff;}
                ...
                @media(min-width:1024px){
                    :is(.single-post,.page-template-default) #main-header .menu-searchform__group nav ul li a{color:#fff;opacity:.5;}
                    :is(.single-post,.page-template-default) #main-header .menu-searchform__group nav ul li a:hover{opacity:1;}
                }
            <?php endif; ?>
