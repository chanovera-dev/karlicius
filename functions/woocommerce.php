...
function flywithwp_woo_add_to_cart_replace() {
    ...
    echo do_shortcode('<a href="'.$link.'" class="button add_to_cart_button flywithwp_cart_btn ajax_add_to_cart"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-bag-plus" viewBox="0 0 16 16">
