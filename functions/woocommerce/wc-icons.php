...
function theme_icons() {
    ?>
        <style>
            ...
            .woocommerce p.stars a.star-2:hover ~ a.star-1:before{content: ''; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/icons/star-fill.svg')!important;}
        </style>
    <?php
}
