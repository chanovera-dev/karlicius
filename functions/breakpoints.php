    ...
    ?>
        <style>
            ...
            @media screen and (min-width: 31px) and (max-width: 1023px){
                /* M E N Ú    M O B I L E */
                #main-header.container .section{display:grid;grid-template-columns:auto 1fr auto;gap:30px;padding:10px 0 30px;max-height:50px;align-items:center;overflow:hidden;transition:all .3s ease;}
