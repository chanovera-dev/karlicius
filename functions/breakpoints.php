    ...
    ?>
        <style>
            ...
            @media(min-width:1024px){
                ...
                #menu-searchform__group .search-form__wrapper #close-search__button{display:grid;place-content:center;position:absolute;top:0;right:0;width:38px;height:38px;border:1px solid transparent;background-color:transparent;color:var(--wp--preset--color--text-b);opacity:1;transition:all .3s ease;z-index:2;}
                ...
                #menu-searchform__group .search-form__wrapper.open #close-search__button{opacity:0;}
