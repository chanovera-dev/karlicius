    ...
    ?>
        <style>
            ...
            @media(min-width:1024px){
                ...
                .searchform{max-width:38px;}
                .searchform input[type=search]{opacity:0;}
                #menu-searchform__group .searchform .search-submit__button{width:38px;height:38px;top:0;right:0;border:1px solid transparent;background-color:transparent;color:var(--wp--preset--color--text-b);z-index:1;}
                #menu-searchform__group .searchform:hover .search-submit__button{color:var(--wp--preset--color--text);}
                #menu-searchform__group #close-search__button{display:grid;place-content:center;position:absolute;top:0;right:0;width:38px;height:38px;border:1px solid transparent;background-color:transparent;color:var(--wp--preset--color--text-b);transition:all .3s ease;z-index:2;}
                #menu-searchform__group #close-search__button:hover{color:var(--wp--preset--color--text);}
